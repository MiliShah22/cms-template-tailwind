...
export function ResetPasswordFormLayout2() {
                    ...
                    {!isSuccess ? (
                        <>
                            <div className="text-center">
                                ...
                                <p className="text-slate-600 dark:text-slate-400">Enter your new password below to finish resetting.</p>
                            </div>
                                        ...
                                        <div className="space-y-2">
                                            <div className="flex space-x-1">
                                                {[1, 2, 3, 4, 5].map((level) => (
                                                    <div
                                                        key={level}
                                                        className={`h-2 w-full rounded-full ${level <= passwordStrength ? strengthColors[passwordStrength - 1] : "bg-slate-200"
                                                            }`}
                                                    />
                                                ))}
                                            </div>
                            ...
                            <div className="text-center">
                                <Link href="/auth/login-v2" className="text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200">
                                    Back to sign in
                                </Link>
                            </div>
                        </>
                        ...
                        <div className="space-y-6 text-center">
                            ...
                            <p className="text-slate-600 dark:text-slate-400">You can now sign in with your new password.</p>
