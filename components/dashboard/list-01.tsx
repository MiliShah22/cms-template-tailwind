...
const ACCOUNTS: AccountItem[] = [
  {
    id: "1",
    title: "Stripe USD",
    description: "Live subscription payments",
    balance: "$18,430.00",
    type: "savings",
  },
  {
    id: "2",
    title: "PayPal",
    description: "One‑time license sales",
    balance: "$3,920.50",
    type: "checking",
  },
  {
  ...
  },
  {
    ...
    description: "Cloud & CDN this month",
    balance: "$2,130.00",
    type: "debt",
  },
]

export default function List01({ totalBalance = "$26,430.25", accounts = ACCOUNTS, className }: List01Props) {
  return (
    <div
      className={cn(
