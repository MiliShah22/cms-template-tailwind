...
const activities: Activity[] = [
  {
    ...
    description: "CMS Pro Plan – Yearly activated",
    time: "2 minutes ago",
    user: {
      name: "Jane Cooper",
  ...
  },
  {
    ...
    description: "Cody Fisher created a workspace",
    time: "15 minutes ago",
    user: {
      name: "Cody Fisher",
      avatar: "/placeholder.svg?height=32&width=32",
  ...
  },
  {
    ...
    description: "5-star review for SEO Toolkit Addon",
    time: "1 hour ago",
    user: {
      name: "Kristin Watson",
      avatar: "/placeholder.svg?height=32&width=32",
  ...
  },
  {
    ...
    type: "payment",
    title: "Invoice paid",
    description: "Invoice #INV-2041 settled via Stripe",
    time: "2 hours ago",
    metadata: {
      amount: "$129.00",
      status: "success",
  ...
  },
  {
    id: "5",
    type: "product",
    title: "Addon usage spike",
    description: "Analytics Upgrade attached to 12 new projects",
    time: "3 hours ago",
    metadata: {
      status: "warning",
    },
