// This script runs as early as possible to load and apply saved theme settings
// It should be injected in the HTML head to avoid flash of unstyled content

export function injectThemeLoader() {
